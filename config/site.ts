...
export const footerLinks: SidebarNavItem[] = [
  ...
  },
  {
    title: "Services",
    items: [
      { title: "Daily Living Support", href: "#" },
      { title: "Personal Care Services", href: "#" },
      { title: "Respite Care", href: "#" },
      { title: "Skilled Nursing Care", href: "#" },
      { title: "Specialized Care Services", href: "#" },
    ],
  },
  {
    title: "Docs",
